(function () {
  ...
  function parseIngFile(index, fn) {
    return (
        $.ajax({
          url: fn,
          dataType: 'text',
          success: function (doc) {
            ...
            $("tr", new_doc).each(function () {
              ...
              $(this).find("td").each(function () {
                ...
                parseIngTD(index,topHalf, iterField++, this, props);
              });
              ...
              if (topHalf) {
                ...
                incMetric(index.metrics, "ing", "dlc", props.dlc );
                incMetric(index.metrics, "ing", "plt", props.plt );
  ...
  function setIngEffIdx( idx, template, hash ) {
    idx.h = hash;
  ...
  $(document).ready(function () {
    ...
    index.i = {};
    setIngEffIdx( index.i, 
      { x: 0, n:"", v: -1, w: -1, r: "", o: "", q: "", e: new Array(4) },
